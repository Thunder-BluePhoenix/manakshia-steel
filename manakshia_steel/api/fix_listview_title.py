...
HIDE_NAMING_SERIES_COL = [
    "Adjustment", "Waybill", "Waybill Return", "Production Order",
...
def run():
    ...
    for dt, old_tf in FIX_TITLE_FIELD.items():
        ...
        print(f"  ✓  {dt}: title_field cleared (was '{old_tf}') → name is now first column")
    ...
    for dt in HIDE_NAMING_SERIES_COL:
        ...
        _upsert_ps(dt, "naming_series", "DocField", "in_list_view", "Check", "0", ps_name)
