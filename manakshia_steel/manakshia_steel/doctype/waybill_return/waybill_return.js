  ...
  waybill(frm) {
    if (frm.doc.waybill) {
      frappe.db.get_doc("Waybill", frm.doc.waybill).then((waybill) => {
        ...
        frm.set_value(
          "custom_production_order_no",
          waybill.custom_production_order_no
        );
        frm.set_value(
          "custom_production_order_date",
          waybill.custom_production_order_date
        );
        ...
        frm.set_value(
          ...
          waybill.total_taxes_and_charges
        );
